...
- The mobile-reports command is **/charts** (the ☰ menu entry too) — one
  letter away from `/report`, the daily digest, was one confusion too many.
  `/reports` keeps working as a silent alias.
