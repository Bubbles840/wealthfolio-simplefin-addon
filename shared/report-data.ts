/**
 * shared/report-data.ts
 *
 * (Moved from src/components/budget/ in v1.44.0: the companion's report
 * renderer — Telegram images and the mini app — needs the same preparation,
 * and this module was always pure cube-in, rows-out.)
 *
...
import { computePoolStatus, computeRunwayMonths } from './pool.js';
